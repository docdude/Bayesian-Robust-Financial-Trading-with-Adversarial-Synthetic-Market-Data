...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(ROOT, "configs", "downloader", "prices", "yahoofinance_day_prices_future_etfs.py"), help="download datasets config file path")
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
